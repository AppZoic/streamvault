...
$shop_layout = !empty( $streamvault_opt['shop_layout'] ) ? $streamvault_opt['shop_layout'] : 'full_width';

if(!empty($_GET['shop_layout'])){
    $shop_layout = $_GET['shop_layout'];
}
// http://localhost/streamvault/?shop_layout=left_sidebar&shop_columns=4
