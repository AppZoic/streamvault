...
function streamvault_inline_style() {
	...
	.genre-filters .genre-btn.active,.streamvault-btn, .edit-btn , .single-product .product_meta .tagged_as a:hover, .single-product .product_meta .posted_in a:hover, .woocommerce.single-product .onsale, .single_add_to_cart_button, .dashboard-main .button-secondary,.dashboard-main button, #loading .object {
	...
	.genre-btn:hover,.genre-filters .genre-btn.active,.scrollToTop, .company-card-list i, .job-type i, .blog-details-meta i, .comment-reply-link, .nav-previous a, .nav-next a, .review-card i, .streamvault-breadcrumb__menu a, .add-extra, .comment .fa-star, .plan-body i.fa-check-circle, .about-list i.fa-check-circle{
		color: <?php echo esc_attr( $primary_color_from ) ?>;
	}

	.skeleton-item,.genre-btn:hover,.single_add_to_cart_button, .nav-previous a, .nav-next a {
